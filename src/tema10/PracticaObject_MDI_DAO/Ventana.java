...
public class Ventana extends JInternalFrame implements ActionListener, InternalFrameListener {
    ...
    private JButton jbtAdd, jbtDelete, jbtChange, jbtshowLeft, jbtshowRight, jbtAgreeAdd, jbtAgreeDel, jbtChangeOne, jbtChangeTwo;
