...
import tema11.alquilerAmarres.ConexionBD;
...
//            con=DriverManager.getConnection("jdbc:mysql://10.2.7.1:3306/negocios2011?zeroDateTimeBehavior=convertToNull", "root", "");
           //crear instruccion JDBC
                Statement stm = ConexionBD.getConection().createStatement();
            //crear instruccion
            ResultSet rs =stm.executeQuery("select * from negocios2011.clientes");
            while(rs.next()){
